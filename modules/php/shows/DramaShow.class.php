...
class DramaShow extends RivalNetworksShow
{
    ...
    private function determineName($season)
    {
        switch($season) {
            case 0:
                return clienttranslate('Get to Know Your Lower Colon');
            case 1:
                return clienttranslate('Alive, As Far As We\'re Concerned');
            case 2:
                return clienttranslate('The Mediocre Mr. Muddle');
            case 3:
                return clienttranslate('The Handmade Tail');
            default:
                return '';
        }
    }
    ...
    /**
     * Add a Mega-Star to your Green Room
     * @return void
     */
